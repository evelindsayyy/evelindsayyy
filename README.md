...
-  **[ddl_reminder](https://github.com/evelindsayyy/ddl_reminder)** — Next.js + Supabase deadline tracker I use daily: natural-language entry, email reminders, Apple Calendar feed, Canvas/Gradescope sync, installable PWA.
